...
namespace fibonacci_multithreading
{
    class Program
    {
        ...
        public static void thread2()//second thread
        {
            ...
            */
            Console.Write("Reverse of Fibonacci Series = ");       //prints the title
            for (int i = 9; i >= 0; i--)                          //for loop to execute the process and print 10 fibonacci numbers in reverse order
            {
                CreateFibSeries();                              //here the function is called 
                Console.Write(" " + Container.fibseries[i]);   //in order to print the fibonacci listed numbers I wrote this line. It puts a space between each number everytime.
                Thread.Sleep(500);                            //with this method the program pauses for 0.5 seconds everytime the program prints. 500 miliseconds.
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            thread2();          //thread2() is run. prints fibonacci numbers in reverse order with 0.5 seconds between each time it outputs
